...
const LaboratoireDeMetrologie = () => {
  ...
  const services = [
    ...
    { icon: <FaCheckCircle className="text-4xl text-red-600 mx-auto mb-4" />, title: "Pièces complexe", description: "Contrôle rigoureux des moyens de production pour une qualité optimale.", imgSrc: '/téléchargement (2).jpg' ,link: '/complexe' },
