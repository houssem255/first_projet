...
export function CarouselDefault() {
  ...
  return (
    <Carousel className="rounded-xl">
            ...
            <p>
              {showFullText ? (
                <>
                  ...
                  Le complexe est spécialisé dans la production de pièces pour divers véhicules industriels et engins d&apos;une capacité de 10 000 T/An et compte 200 salariés en majorité jeunes. 
      ...
      <div className="relative w-full h-[400px]">
        <img
          src="/413967780_347185794737903_6876295416100804191_n-imageonline.co-merged.jpg"
