          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:text-center">
              ...
              <ul className="space-y-2">
                <li className="text-gray-300 hover:scale-110 hover:text-white ease-out duration-200"><Link href="#"  >FACEBOOK</Link></li>
                <li className="text-gray-300 hover:scale-110 hover:text-white ease-out duration-200"><Link href="#"  >TWITTER</Link></li>
                <li className="text-gray-300 hover:scale-110 hover:text-white ease-out duration-200"><Link href="#">INSTAGRAM</Link></li>
              </ul>
            </div>
            ...
            <div className="md:text-center">
              ...
              <ul className="space-y-2">
                <li className="text-gray-300 hover:scale-110 hover:text-white ease-out duration-200"><Link href="/" >Accueil</Link></li>
